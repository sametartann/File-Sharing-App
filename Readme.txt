...
First, you need to run ChunkAnnouncer.py and write the name of the file you want to upload (i.e., name.png). It will open a file called 'Chunk_Files' which contains 5 chunks. Then, you will write your username to the console. It will start to periodically send broadcast UDP message once per minute.
...
Finally, run DownloadChunk.py . In the console, you can see the files names shared in the network and ip adresses of senders. Write the name of the file (i.e., name.png) to the console. It will open a file called 'Downloads', which contains all files you download.
